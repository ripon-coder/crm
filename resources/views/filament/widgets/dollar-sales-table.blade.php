<x-filament-widgets::widget class="col-span-full" style="grid-column: 1 / -1 !important;">
    <x-filament::section>
        {{-- Filters --}}
        <div style="display: grid; grid-template-columns: 1fr 1fr auto; gap: 1rem; margin-bottom: 1.5rem; align-items: end;">
            ...
            <button wire:click="applyFilters" type="button" style="padding: 0.625rem 1.5rem; background-color: rgb(251 146 60); color: white; font-size: 0.875rem; font-weight: 600; border-radius: 0.5rem; border: none; cursor: pointer; transition: background-color 0.15s; white-space: nowrap;" onmouseover="this.style.backgroundColor='rgb(249 115 22)'" onmouseout="this.style.backgroundColor='rgb(251 146 60)'">
                Filter
            </button>
        </div>
        ...
        <div style="margin-top: 1.5rem; overflow: hidden; border-radius: 0.75rem; background-color: white; box-shadow: 0 1px 3px 0 rgb(0 0 0 / 0.1); border: 1px solid rgb(229 231 235);">
            <div style="overflow-x: auto;" wire:key="table-{{ $appliedYear }}-{{ $appliedMonth }}">
