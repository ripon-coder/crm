...
<div class="bg-white dark:bg-gray-800 shadow rounded p-2 flex justify-between">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded p-2">
        <h3 class="text-sm font-semibold mb-1">Project Details</h3>
        ...
        <div class="space-y-2">
            ...
            <div class="border dark:border-gray-700 rounded p-2 bg-gray-50 dark:bg-gray-900">
                ...
                <div class="flex justify-between text-sm mt-1">
                    ...
                    <span class="font-semibold capitalize">{{ str_replace('_', ' ', $record->status) }}</span>
                </div>

                <div class="flex justify-between text-sm">
                    <span class="text-gray-600">Budget:</span>
                    <span class="font-semibold">৳{{ number_format($record->budget, 2) }}</span>
                </div>
            </div>
            ...
            <div class="border dark:border-gray-700 rounded p-2 bg-gray-50 dark:bg-gray-900">
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-semibold text-red-600">
                        ৳{{ number_format($record->budget - $record->payments->sum('amount'), 2) }}
                    </span>
                </div>
            </div>
